...
<body>
    <div id="my_app">
        <nav style="background-color: black" class="navbar fixed-top navbar-expand-md shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('uploads/img/logo.png') }}" alt="" srcset="" width="60" height="60" style="transition: 300ms ease;">
